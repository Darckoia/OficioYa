...
export function CTA() {
  return (
    <section className="py-12 sm:py-16">
      <Container>
        <div className="surface-card overflow-hidden bg-brand-600 px-6 py-10 text-white sm:px-10 dark:bg-brand-700">
          ...
          <div className="mt-4 flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
            ...
            <Button href="/demo" variant="secondary" className="self-start text-brand-700 dark:text-white">
