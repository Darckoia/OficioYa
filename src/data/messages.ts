...
export type MessageTone = 'Cercano' | 'Formal' | 'Urgente';
...
export const messageTones: MessageTone[] = ['Cercano', 'Formal', 'Urgente'];
export const messageChannels: MessageChannel[] = ['WhatsApp', 'Instagram', 'Email'];
